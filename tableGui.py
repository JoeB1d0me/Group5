...
class TableGui():
  ...
  def aboutOpen(self):
    ...
    self.aboutDesc = Label(self.aboutWindow, text = "GUI/CRUD of Flight Attendants and Pilots for CS50 Period 6 by Group 5", wraplength = 100)
    self.aboutDesc.pack()
  ...
  def pilotWindowOpen(self):
    ...
    self.pilotTableCanvas = tk.Canvas(self.pilotTableRoot, width=450, height=300)
    ...
    self.pilotVarPos = tk.OptionMenu(self.pilotTableCanvas, self.pilotVP, "placeholder", "placeholder1")
    self.planeQualification1 = tk.OptionMenu(self.pilotTableCanvas, self.varPQ1,
                                          "Yes", "No")
    self.planeQualification2 = tk.OptionMenu(self.pilotTableCanvas, self.varPQ2,
                                          "Yes", "No")
    self.planeQualification3 = tk.OptionMenu(self.pilotTableCanvas, self.varPQ3,
                                          "Yes", "No")
    ...
    self.pilotsVeryLastButton = Button(
  ...
  def flightAttendantWindowOpen(self):
    ...
    self.posLabel = tk.Label(self.flightAttendantCanvas,
                          text="Position")
    ...
    self.pos = tk.OptionMenu(self.flightAttendantCanvas, self.faVarPos, "placeholder1", "placeholder2", "placeholder3", "placeholder4")
  ...
  def __init__(self):
    ...
    self.connectMenu.add_command(label="Connect", command= lambda:SqlCommandClass.connect(self))
    self.connectMenu.add_command(label="Disconnect", command= lambda:SqlCommandClass.disconnect(self))
